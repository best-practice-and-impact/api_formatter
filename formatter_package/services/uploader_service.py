...
class UploaderService:
    ...
    def _upload(self, user, file_path: str, config_class, schema) -> FileRecord:
    ...
    def upload_edition(self, user, file_path: str) -> FileRecord:
        return self._upload(user, file_path, EditionConfig, self.edition_schema)
    ...
    def edit_metadata(self, user, record: FileRecord, new_data: dict):
        ...
        if record.metadata.get("type") == "edition":
